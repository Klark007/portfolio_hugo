...
<div id="slider1" class="beer-slider" data-beer-label="Mitsuba">
  <img src="/images/pathtracer/anisotropic_dir_ref.png" alt="">

  <div class="beer-reveal" data-beer-label="Mine">
    <img src="/images/pathtracer/anisotropic_dir.png" alt="">
  </div>
</div>

Also important to add was texture support for the materials.
<div id="slider1" class="beer-slider" data-beer-label="Mitsuba">
  <img src="/images/pathtracer/texture_path_ref.png" alt="">

  <div class="beer-reveal" data-beer-label="Mine">
    <img src="/images/pathtracer/texture_path.png" alt="">
  </div>
</div>
